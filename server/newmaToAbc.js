...
const abcKeySignature = { ":1s": "G", ":2s": "D", ":3s": "A", ":4s": "E", ":5s": "B", ":6s": "F#", ":7s": "C#", ":1b": "F", ":2b": "Bb", ":3b": "Eb", ":4b": "Ab", ":5b": "Db", ":6b": "Gb", ":7b": "Cb" };

const abcTimeSignature = {
    "1:1" : ["1/1", "1/1"], "2:1" : ["2/1", "1/1"], "3:1" : ["3/1", "1/1"], "4:1" : ["4/1", "1/1"], "5:1" : ["5/1", "1/1"], "6:1" : ["6/1", "1/1"], "7:1" : ["7/1", "1/1"], "8:1" : ["8/1", "1/1"], "9:1" : ["9/1", "1/1"], "10:1" : ["10/1", "1/1"], "11:1" : ["11/1", "1/1"], "12:1" : ["12/1", "1/1"],
    "1:2" : ["1/2", "1/2"], "2:2" : ["C|", "1/2"], "3:2" : ["3/2", "1/2"], "4:2" : ["4/2", "1/2"], "5:2" : ["5/2", "1/2"], "6:2" : ["6/2", "1/2"], "7:2" : ["7/2", "1/2"], "8:2" : ["8/2", "1/2"], "9:2" : ["9/2", "1/2"], "10:2" : ["10/2", "1/2"], "11:2" : ["11/2", "1/2"], "12:2" : ["12/2", "1/2"],
    "1:4" : ["1/4", "1/4"], "2:4" : ["2/4", "1/4"], "3:4" : ["3/4", "1/4"], "4:4" : ["C", "1/4"], "5:4" : ["5/4", "1/4"], "6:4" : ["6/4", "1/4"], "7:4" : ["7/4", "1/4"], "8:4" : ["8/4", "1/4"], "9:4" : ["9/4", "1/4"], "10:4" : ["10/4", "1/4"], "11:4" : ["11/4", "1/4"], "12:4" : ["12/4", "1/4"],
    "1:8" : ["1/8", "1/8"], "2:8" : ["2/8", "1/8"], "3:8" : ["3/8", "1/8"], "4:8" : ["4/8", "1/8"], "5:8" : ["5/8", "1/8"], "6:8" : ["6/8", "1/8"], "7:8" : ["7/8", "1/8"], "8:8" : ["8/8", "1/8"], "9:8" : ["9/8", "1/8"], "10:8" : ["10/8", "1/8"], "11:8" : ["11/8", "1/8"], "12:8" : ["12/8", "1/8"],
};
...
const abcCleaves = {
    "flute": { name: "Flute", clef: "treble", transposition: 0 },
    "flute+": { name: "Flute", clef: "treble", transposition: 0 },
    "petite_flute_reb": { name: "Petite flute Réb 9e+", clef: "treble", transposition: 1290 }, 
    "petite_flute_reb+": { name: "Petite flute Réb 9e+", clef: "treble", transposition: 1290 }, 
    "hautbois": { name: "Hautbois", clef: "treble", transposition: 0 }, 
    "hautbois+": { name: "Hautbois", clef: "treble", transposition: 0 }, 
    "cor_anglais": { name: "Cor anglais Fa", clef: "treble", transposition: -702 }, 
    "cor_anglais+": { name: "Cor anglais Fa", clef: "treble", transposition: -702 }, 
    "clarinette_mib": { name: "Clarinette Mib", clef: "treble", transposition: 294 }, 
    "clarinette_mib+": { name: "Clarinette Mib", clef: "treble", transposition: 294 }, 
    "clarinette_sib": { name: "Clarinette Sib", clef: "treble", transposition: -204 }, 
    "clarinette_sib+": { name: "Clarinette Sib", clef: "treble", transposition: -204 }, 
    "clarinette_basse": { name: "Clarinette basse Sib 9e-", clef: "treble", transposition: -1404 }, 
    "clarinette_basse+": { name: "Clarinette basse Sib 9e-", clef: "treble", transposition: -1404 }, 
    "basson": { name: "Basson", clef: "bass", transposition: 0 }, 
    "basson+": { name: "Basson", clef: "bass", transposition: 0 }, 
    "contrebasson": { name: "Contrebasson", clef: "bass", transposition: 0 }, 
    "contrebasson+": { name: "Contrebasson", clef: "bass", transposition: 0 }, 
    "cor": { name: "Cor Fa", clef: "treble", transposition: 702 }, 
    "cor+": { name: "Cor Fa", clef: "treble", transposition: 702 }, 
    "cor++": { name: "Cor Fa", clef: "treble", transposition: 702 }, 
    "trompette_re": { name: "Trompette Ré", clef: "treble", transposition: 204 }, 
    "trompette_ut": { name: "Trompette Ut", clef: "treble", transposition: 0 }, 
    "trompette_ut+": { name: "Trompette Ut", clef: "treble", transposition: 0 }, 
    "trompette_sib": { name: "Trompette Sib", clef: "treble", transposition: -204 }, 
    "trombone": { name: "Trombone", clef: "bass", transposition: 0 }, 
    "trombone+": { name: "Trombone", clef: "alto", transposition: 0 }, 
    "trombone++": { name: "Trombone", clef: "alto2", transposition: 0 }, 
    "tuba": { name: "Tuba", clef: "bass", transposition: 1902 }, 
    "timbale": { name: "Timbale", clef: "perc", transposition: 0 }, 
    "tambour": { name: "Tambour", clef: "perc", transposition: 0 }, 
    "cymballe": { name: "Cymballe", clef: "perc", transposition: 0 }, 
    "percussion": { name: "", clef: "perc", transposition: 0 },
    "harpe": { name: "Harpe", clef: "treble", transposition: 0 }, 
    "harpe+": { name: "Harpe", clef: "bass", transposition: 0 }, 
    "violon": { name: "Violon", clef: "treble", transposition: 0 }, 
    "violon+": { name: "Violon", clef: "treble", transposition: 0 }, 
    "violon++": { name: "Violon", clef: "treble", transposition: 0 }, 
    "alto": { name: "Alto", clef: "alto", transposition: 0 }, 
    "alto+": { name: "Alto", clef: "alto", transposition: 0 }, 
    "violoncelle": { name: "Violoncelle", clef: "bass", transposition: 0 }, 
    "violoncelle+": { name: "Violoncelle", clef: "bass", transposition: 0 }, 
    "contrebasse": { name: "Contrebasse 8ve-", clef: "bass", transposition: -1200 }, 
    "contrebasse+": { name: "Contrebasse 8ve-", clef: "bass", transposition: -1200 }, 

    "sol": { name: "", clef: "treble", transposition: 0 },
    "sol+": { name: "", clef: "treble", transposition: 0 },
    "ut1": { name: "", clef: "alto1", transposition: 0 },
    "ut2": { name: "", clef: "alto2", transposition: 0 },
    "ut3": { name: "", clef: "alto", transposition: 0 },
    "ut4": { name: "", clef: "tenor", transposition: 0 },
    "fa3": { name: "", clef: "bass3", transposition: 0 },
    "fa4": { name: "", clef: "bass", transposition: 0 },
    "fa4+": { name: "", clef: "bass", transposition: 0 },
    "soprano": { name: "Soprano", clef: "treble", transposition: 0 },
    //"alto": { name: "Alto", clef: "treble", transposition: 0 },
    "tenor": { name: "Tenor", clef: "treble-8", transposition: 0 },
    "bass": { name: "Bass", clef: "bass", transposition: 0 },
};
...
function toAbcjs(score, startMeasure = 1, scoreSize = null, tempo = 72) {
    let abcScript =  "X: 1 \n";
    if (score.composer) abcScript += "C: " + score.composer + "\n";
    if (score.title) abcScript += "T: " + score.title + "\n";
    abcScript +=  "Q:" + tempo + "\n";
    let i = 0;
    let keySignature = null, timeSignature = null, timeNum, timeRef, startPos = new Fraction(Number.MAX_VALUE);

    let staves = {};
    Object.keys(score.voices).forEach(voi => { 
        const splitted = voi.split("|"), staf = (splitted.length > 1) ? splitted[0] : voi;
        if (!staves[staf]) staves[staf] = [splitted.join("")];
        else staves[staf].push(splitted.join(""));
    });

    let staveScript = "%%staves ";
    Object.keys(staves).forEach(stafKey => {
        staveScript += "(";
        staveScript += staves[stafKey].join(" ");
        staveScript += ")";
    });
    staveScript += "\n";
    abcScript += staveScript;

    Object.keys(score.voices).forEach(voi => {
        const voice = score.voices[voi];
        if (startPos.compare(voice[0].pos) > 0) startPos = voice[0].pos; 
    });

    Object.keys(score.voices).forEach(voi => {
        if (voi.charAt(0) == ":") voi = voi.substring(1);
        const voice = score.voices[voi];
        const splitted = voi.split("|"), name = splitted.join(""), voiceType = splitted[0];
        let first = true;
        let voiceScript = "V:" + name;
        let lyrics = null;

        if (abcCleaves[voiceType] && abcCleaves[voiceType].name) voiceScript += " name=" + abcCleaves[voiceType].name;
        const cleaves = {":clg2": "treble", ":clc1": "alto1", ":clc2": "alto2", ":clc3": "alto", ":clc4": "tenor", ":clf4": "bass", ":clf3": "bass3", ":clperc": "perc"};
        let clef;
        if (voice[0]) {
            for (const key of Object.keys(cleaves)) {
                if (voice[0].properties.includes(key)) clef = cleaves[key];
            }    
        }
        if (!clef) clef = splitted[2];
        if (!clef) clef = (abcCleaves[voiceType]) ? abcCleaves[voiceType].clef : "treble";
        voiceScript += " clef=" + clef + " \n";

        //    if (keySignature) voiceScript += "K: " + keySignature + " \n";
        let chords = [], currentChord = null;
        voice.forEach(note => {
            let newKS = note.keySignature(), newTS = note.timeSignature;
            if (newKS) newKS = abcKeySignature[newKS];
            if (newTS) {
                [timeNum, timeRef] = ((timeSignature) => timeSignature.split(":"))(newTS);
                newTS = abcTimeSignature[newTS];
            }
            if (keySignature != newKS) keySignature = newKS;
            if (timeSignature != newTS) timeSignature = newTS;

            if (note.properties.includes(":grace")) {
                chords.push(note);
            }
            else if (!currentChord || note.pos > currentChord.pos) {
                let currentPos = new Fraction((currentChord) ? currentChord.pos + currentChord.dur : startPos);
                let gap = new Fraction(note.pos - currentPos);
                while (gap > 0) {
                    const increment = Math.min(gap, timeNum);
                    chords.push({ voi: note.voi, pos: new Fraction(currentPos), dur: new Fraction(increment), hei: [":rest"], timeSignature: note.timeSignature, keySignature: note.keySignature, properties: note.properties })
                    gap -= increment;
                    currentPos += increment;
                }
                currentChord = note;
                currentChord.hei = [note.hei];
                chords.push(currentChord);
            }
            else currentChord.hei.push(note.hei);
            lyrics = note.lyrics;
        });
        keySignature = null; timeSignature = null; timeNum = 4; timeRef;
        let baseHei = { 0: 0, 204: 204, 408: 408, 498: 498, 702: 702, 906: 906, 1110: 1110 }, currentHei = { ...baseHei };
        let grace = false;
        chords.forEach( chord => {
            const currentMeasure = chord.pos / timeNum + 1; 
            if (currentMeasure >= startMeasure && (!scoreSize || currentMeasure <= startMeasure + scoreSize)) {
                if (!first && chord.pos.mod(timeNum) == 0) {
                    voiceScript += " | ";
                    currentHei = { ...baseHei };
                }
          
                let newKS = chord.keySignature(), newTS = chord.timeSignature;
                if (newKS) newKS = abcKeySignature[newKS];
                if (newTS) {
                    [timeNum, timeRef] = ((timeSignature) => timeSignature.split(":"))(newTS);
                    newTS = abcTimeSignature[newTS];
                }
                if (keySignature != newKS) {
                    keySignature = newKS;
                    voiceScript += "[K: " + keySignature + "] ";
                }
                if (timeSignature != newTS) {
                    timeSignature = newTS;
                    voiceScript += "[M: " + timeSignature[0] + "] [L: " + timeSignature[1] + "] ";
                }
  
                if (chord.properties.includes(":grace")) {
                    if (!grace) voiceScript += "{";
                    grace = true;
                }
                else if (!chord.properties.includes(":grace")) {
                    if (grace) voiceScript += "}";
                    grace = false;
                }

                let codedHei = "";
                if (chord.hei == ":rest") codedHei = "z";
                else {
                    let heights = chord.hei;
                    if (!Array.isArray(heights)) heights = [heights];
                    if (heights.length > 1) codedHei += "[";
                    let toReset = {};
                    heights.forEach( hei => {
                        if (!isNaN(hei)) {
                            // transpose
                            if (abcCleaves[voi]) hei = hei + abcCleaves[voi].transposition;
                            // Infer natural sign
                            const nat = natural(hei), modulo = (hei % 1200 + 1200) % 1200;
                            if (modulo == nat) {
                                if (currentHei[modulo] != nat) codedHei += "=";
                            }
                            toReset[nat] = modulo;
                            codedHei += abcHeights[hei].hei;
                        }
                    });
                    for (key of Object.keys(toReset)) currentHei[key] = toReset[key];
                    if (heights.length > 1) codedHei += "]";
                }
                // to be activated        let codedDur = decodeDur(new Fraction(chord.dur * timeRef / 4));
                let codedDur = decodeDur(chord.dur);
                let codedNote;
                codedNote = codedHei + codedDur;
                voiceScript += codedNote;
                if (chord.pos.add(chord.dur).mod(1) == 0) voiceScript += " ";
                first = false;
            }
        });
        abcScript += voiceScript + "\n";
        if (lyrics) abcScript += 'w:' +  lyrics[1] + "\n";
    });
